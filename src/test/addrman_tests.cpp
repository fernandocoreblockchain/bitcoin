...
BOOST_AUTO_TEST_CASE(addrman_simple)
{
    ...
    BOOST_CHECK_EQUAL(addr_ret1.ToString(), "250.1.1.1:7733");
    ...
    vAddr.push_back(CAddress(ResolveService("250.1.1.3", 7733), NODE_NONE));
    vAddr.push_back(CAddress(ResolveService("250.1.1.4", 7733), NODE_NONE));
...
BOOST_AUTO_TEST_CASE(addrman_ports)
{
    ...
    CService addr1_port = ResolveService("250.1.1.1", 7734);
    addrman.Add(CAddress(addr1_port, NODE_NONE), source);
    BOOST_CHECK_EQUAL(addrman.size(), 1);
    CAddrInfo addr_ret2 = addrman.Select();
    BOOST_CHECK_EQUAL(addr_ret2.ToString(), "250.1.1.1:7733");
...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    BOOST_CHECK_EQUAL(addr_ret3.ToString(), "250.1.1.1:7733");
    ...
    addrman.Add(CAddress(addr2, NODE_NONE), ResolveService("250.3.1.1", 7733));
    addrman.Add(CAddress(addr3, NODE_NONE), ResolveService("250.3.1.1", 7733));
    addrman.Add(CAddress(addr4, NODE_NONE), ResolveService("250.4.1.1", 7733));
    ...
    addrman.Add(CAddress(addr5, NODE_NONE), ResolveService("250.3.1.1", 7733));
    addrman.Good(CAddress(addr5, NODE_NONE));
    addrman.Add(CAddress(addr6, NODE_NONE), ResolveService("250.3.1.1", 7733));
    addrman.Good(CAddress(addr6, NODE_NONE));
    addrman.Add(CAddress(addr7, NODE_NONE), ResolveService("250.1.1.3", 7733));
...
BOOST_AUTO_TEST_CASE(addrman_find)
{
    ...
    CAddress addr3 = CAddress(ResolveService("251.255.2.1", 7733), NODE_NONE);
    ...
    BOOST_REQUIRE(info1);
    BOOST_CHECK_EQUAL(info1->ToString(), "250.1.2.1:7733");
    ...
    BOOST_REQUIRE(info3);
    BOOST_CHECK_EQUAL(info3->ToString(), "251.255.2.1:7733");
}
...
BOOST_AUTO_TEST_CASE(addrman_create)
{
    ...
    BOOST_CHECK_EQUAL(pinfo->ToString(), "250.1.2.1:7733");

    CAddrInfo* info2 = addrman.Find(addr1);
    BOOST_CHECK_EQUAL(info2->ToString(), "250.1.2.1:7733");
}
